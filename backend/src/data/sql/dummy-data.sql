...
VALUES
    ('user1id', 'JohnDoe', 'https://cdn.pixabay.com/photo/2022/08/28/21/51/cartoon-7417574_1280.png', 'password123', 'publicKey1', CURRENT_TIMESTAMP, NULL, 100),
    ('user2id', 'JaneSmith', 'https://cdn.pixabay.com/photo/2022/08/28/21/50/cartoon-7417572_1280.png', 'password456', 'publicKey2', CURRENT_TIMESTAMP, NULL, 200),
    ('user3id', 'MikeBrown', 'https://cdn.pixabay.com/photo/2022/08/28/21/52/cartoon-7417586_1280.png', 'password789', 'publicKey3', CURRENT_TIMESTAMP, NULL, 150),
    ('user4id', 'LucyGreen', 'https://cdn.pixabay.com/photo/2022/08/28/21/51/cartoon-7417578_1280.png', 'password000', 'publicKey4', CURRENT_TIMESTAMP, NULL, 175);

-- populate supportQuestions table
INSERT INTO supportQuestions (timestamp, userId, title, description, answered, answer)
VALUES
    (CURRENT_TIMESTAMP, 'user1id', 'How to send crypto?',
    ...
    (CURRENT_TIMESTAMP, 'user2id', 'How should I proceed with the verification process?',
    ...
    (CURRENT_TIMESTAMP, 'user3id', 'What if I forget my password?',
    ...
    (CURRENT_TIMESTAMP, 'user4id', 'Where can I check my transaction history?',
